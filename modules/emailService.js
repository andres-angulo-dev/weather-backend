...
const sendWelcomeEmail = (userEmail, userName) => {
  ...
  const mailOptions = {
    ...
    html: `<div style="padding: 0% 5%; display: flex; align-items: center; justify-content: center">
          ...
          <p style="margin: 20px 0">Thank you for choosing Weather !<br>Please confirm  your email address to help us ensure your account is always protected by clicking the button below :<p> 
          ...
          <div style="width: 100%; height: 2px; background-color: rgba(0, 0, 0, 0.4)"></div>
          <p style="margin: 20px 0 0 0"><i>Weather ⓒ All rights reserved<i><p>
          </div>
          </div>`        
  };
