...
const generateValidationToken = (userEmail, password) => {
  return jwt.sign({ email: userEmail, password: password }, process.env.JWT_SECRET, {expiresIn: '15m' });
};
...
module.exports = { generateVerificationToken,  generateValidationToken, generateAccessToken, generateRefreshToken };